...
<div class="people-list">
  ...
  <article class="person">
    ...
    <div>
      ...
      <p class="person-links">  
        <a href="{{ '/files/lab member CVs/CV - Chenghao Wang - 2026-04.pdf' | relative_url }}">Curriculum Vitae (Apr 2026)</a>
      </p>
      <p class="person-links"> 
      ...
      <p>Dr. Wang is a joint assistant professor in the School of Meteorology and the Department of Geography and Environmental Sustainability at the University of Oklahoma. He obtained his Ph.D. in Civil, Environmental and Sustainable Engineering from Arizona State University in 2019. From 2020 to 2022, he was a postdoctoral research fellow at Stanford University, where he also served as an inaugural New Map of Life Fellow at the Stanford Center on Longevity.</p>
      <p>His research focuses on understanding the mechanisms of urban environments, their interactions with regional and global climate systems, and their interconnected impacts on energy use, emissions, and planetary health. Through interdisciplinary physics-based modeling and data-driven analytical approaches, his work advances fundamental understanding of complex urban systems and supports the development of more sustainable and resilient cities under global environmental change.</p>
      <p>Dr. Wang is a recipient of NASA Early Career Investigator Award, NSF EPSCoR Research Fellowship, and American Meteorological Society STAC Outstanding Early Career Award. At the University of Oklahoma, he has received several research honors, including the VPRP Award for Excellence in Transdisciplinary and Convergent Research, the College of Atmospheric & Geographic Sciences Superior Research Award & the Outstanding Research Performance Award, and the School of Meteorology Faculty Award for Excellence in Research.</p>
      <p>He currently chairs the International Association for Urban Climate (IAUC) Bibliography Committee and the American Meteorological Society (AMS) Committee on Meteorological Aspects of Air Pollution. He also serves as co-lead of the International Association of Hydrological Sciences (IAHS) Urban Water Working Group and the Urban Air Pollution and Interaction with Climate (U-APIC) Urban Extremes for AQ and Weather/Climate Working Group. In addition, he is a member of the American Geophysical Union (AGU) June Bacon-Bercey Scholarship Committee, AGU Edmond M. Dewan Scholarship Committee, AMS Energy Committee, and AMS Committee on Applied Climatology. He served as a contributing author of the Sixth National Climate Assessment (NCA6).</p>
    </div>
  </article>
  ...
  <article class="person">
    ...
    <div>
      ...
      <p>     
        ...
        a multivariate probabilistic approach.
      </p>
    </div>
  </article>
